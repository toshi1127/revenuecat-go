...
// checks if the CreatePaywall409Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePaywall409Response{}

// CreatePaywall409Response struct for CreatePaywall409Response
type CreatePaywall409Response struct {
...
type _CreatePaywall409Response CreatePaywall409Response
...
func (o *CreatePaywall409Response) SetParamNil() {
	o.Param.Set(nil)
}
...
func (o *CreatePaywall409Response) SetBackoffMsNil() {
	o.BackoffMs.Set(nil)
}
...
func (o CreatePaywall409Response) MarshalJSON() ([]byte, error) {
...
func (o CreatePaywall409Response) ToMap() (map[string]interface{}, error) {
...
func (o *CreatePaywall409Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreatePaywall409Response := _CreatePaywall409Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreatePaywall409Response)

	if err != nil {
		return err
	}

	*o = CreatePaywall409Response(varCreatePaywall409Response)

	return err
}

type NullableCreatePaywall409Response struct {
	value *CreatePaywall409Response
	isSet bool
}

func (v NullableCreatePaywall409Response) Get() *CreatePaywall409Response {
	return v.value
}

func (v *NullableCreatePaywall409Response) Set(val *CreatePaywall409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePaywall409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePaywall409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePaywall409Response(val *CreatePaywall409Response) *NullableCreatePaywall409Response {
	return &NullableCreatePaywall409Response{value: val, isSet: true}
}

func (v NullableCreatePaywall409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePaywall409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
