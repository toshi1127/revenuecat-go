...
// checks if the CreatePaywall404Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePaywall404Response{}

// CreatePaywall404Response struct for CreatePaywall404Response
type CreatePaywall404Response struct {
...
type _CreatePaywall404Response CreatePaywall404Response
...
func (o *CreatePaywall404Response) SetParamNil() {
	o.Param.Set(nil)
}
...
func (o *CreatePaywall404Response) SetBackoffMsNil() {
	o.BackoffMs.Set(nil)
}
...
func (o CreatePaywall404Response) MarshalJSON() ([]byte, error) {
...
func (o CreatePaywall404Response) ToMap() (map[string]interface{}, error) {
...
func (o *CreatePaywall404Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreatePaywall404Response := _CreatePaywall404Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreatePaywall404Response)

	if err != nil {
		return err
	}

	*o = CreatePaywall404Response(varCreatePaywall404Response)

	return err
}

type NullableCreatePaywall404Response struct {
	value *CreatePaywall404Response
	isSet bool
}

func (v NullableCreatePaywall404Response) Get() *CreatePaywall404Response {
	return v.value
}

func (v *NullableCreatePaywall404Response) Set(val *CreatePaywall404Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePaywall404Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePaywall404Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePaywall404Response(val *CreatePaywall404Response) *NullableCreatePaywall404Response {
	return &NullableCreatePaywall404Response{value: val, isSet: true}
}

func (v NullableCreatePaywall404Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePaywall404Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
