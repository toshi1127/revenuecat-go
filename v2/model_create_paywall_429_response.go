...
// checks if the CreatePaywall429Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePaywall429Response{}

// CreatePaywall429Response struct for CreatePaywall429Response
type CreatePaywall429Response struct {
...
type _CreatePaywall429Response CreatePaywall429Response
...
func (o *CreatePaywall429Response) SetParamNil() {
	o.Param.Set(nil)
}
...
func (o *CreatePaywall429Response) SetBackoffMsNil() {
	o.BackoffMs.Set(nil)
}
...
func (o CreatePaywall429Response) MarshalJSON() ([]byte, error) {
...
func (o CreatePaywall429Response) ToMap() (map[string]interface{}, error) {
...
func (o *CreatePaywall429Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreatePaywall429Response := _CreatePaywall429Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreatePaywall429Response)

	if err != nil {
		return err
	}

	*o = CreatePaywall429Response(varCreatePaywall429Response)

	return err
}

type NullableCreatePaywall429Response struct {
	value *CreatePaywall429Response
	isSet bool
}

func (v NullableCreatePaywall429Response) Get() *CreatePaywall429Response {
	return v.value
}

func (v *NullableCreatePaywall429Response) Set(val *CreatePaywall429Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePaywall429Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePaywall429Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePaywall429Response(val *CreatePaywall429Response) *NullableCreatePaywall429Response {
	return &NullableCreatePaywall429Response{value: val, isSet: true}
}

func (v NullableCreatePaywall429Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePaywall429Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
