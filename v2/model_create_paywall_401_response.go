...
// checks if the CreatePaywall401Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePaywall401Response{}

// CreatePaywall401Response struct for CreatePaywall401Response
type CreatePaywall401Response struct {
...
type _CreatePaywall401Response CreatePaywall401Response
...
func (o *CreatePaywall401Response) SetParamNil() {
	o.Param.Set(nil)
}
...
func (o *CreatePaywall401Response) SetBackoffMsNil() {
	o.BackoffMs.Set(nil)
}
...
func (o CreatePaywall401Response) MarshalJSON() ([]byte, error) {
...
func (o CreatePaywall401Response) ToMap() (map[string]interface{}, error) {
...
func (o *CreatePaywall401Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreatePaywall401Response := _CreatePaywall401Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreatePaywall401Response)

	if err != nil {
		return err
	}

	*o = CreatePaywall401Response(varCreatePaywall401Response)

	return err
}

type NullableCreatePaywall401Response struct {
	value *CreatePaywall401Response
	isSet bool
}

func (v NullableCreatePaywall401Response) Get() *CreatePaywall401Response {
	return v.value
}

func (v *NullableCreatePaywall401Response) Set(val *CreatePaywall401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePaywall401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePaywall401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePaywall401Response(val *CreatePaywall401Response) *NullableCreatePaywall401Response {
	return &NullableCreatePaywall401Response{value: val, isSet: true}
}

func (v NullableCreatePaywall401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePaywall401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
