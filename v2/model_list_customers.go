...
// checks if the ListCustomers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListCustomers{}

// ListCustomers struct for ListCustomers
...
type _ListCustomers ListCustomers
...
func (o ListCustomers) MarshalJSON() ([]byte, error) {
...
func (o ListCustomers) ToMap() (map[string]interface{}, error) {
...
func (o *ListCustomers) UnmarshalJSON(data []byte) (err error) {
	...
	varListCustomers := _ListCustomers{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListCustomers)

	if err != nil {
		return err
	}

	*o = ListCustomers(varListCustomers)

	return err
}

type NullableListCustomers struct {
	value *ListCustomers
	isSet bool
}

func (v NullableListCustomers) Get() *ListCustomers {
	return v.value
}

func (v *NullableListCustomers) Set(val *ListCustomers) {
	v.value = val
	v.isSet = true
}

func (v NullableListCustomers) IsSet() bool {
	return v.isSet
}

func (v *NullableListCustomers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListCustomers(val *ListCustomers) *NullableListCustomers {
	return &NullableListCustomers{value: val, isSet: true}
}

func (v NullableListCustomers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListCustomers) UnmarshalJSON(src []byte) error {
	v.isSet = true
