...
func (o *PackageList) UnmarshalJSON(data []byte) (err error) {
	...
	varPackageList := _PackageList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPackageList)

	if err != nil {
		return err
	}

	*o = PackageList(varPackageList)
