...
// checks if the CreatePaywall422Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePaywall422Response{}

// CreatePaywall422Response struct for CreatePaywall422Response
type CreatePaywall422Response struct {
...
type _CreatePaywall422Response CreatePaywall422Response
...
func (o *CreatePaywall422Response) SetParamNil() {
	o.Param.Set(nil)
}
...
func (o *CreatePaywall422Response) SetBackoffMsNil() {
	o.BackoffMs.Set(nil)
}
...
func (o CreatePaywall422Response) MarshalJSON() ([]byte, error) {
...
func (o CreatePaywall422Response) ToMap() (map[string]interface{}, error) {
...
func (o *CreatePaywall422Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreatePaywall422Response := _CreatePaywall422Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreatePaywall422Response)

	if err != nil {
		return err
	}

	*o = CreatePaywall422Response(varCreatePaywall422Response)

	return err
}

type NullableCreatePaywall422Response struct {
	value *CreatePaywall422Response
	isSet bool
}

func (v NullableCreatePaywall422Response) Get() *CreatePaywall422Response {
	return v.value
}

func (v *NullableCreatePaywall422Response) Set(val *CreatePaywall422Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePaywall422Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePaywall422Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePaywall422Response(val *CreatePaywall422Response) *NullableCreatePaywall422Response {
	return &NullableCreatePaywall422Response{value: val, isSet: true}
}

func (v NullableCreatePaywall422Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePaywall422Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
