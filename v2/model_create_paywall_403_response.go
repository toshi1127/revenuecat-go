...
// checks if the CreatePaywall403Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePaywall403Response{}

// CreatePaywall403Response struct for CreatePaywall403Response
type CreatePaywall403Response struct {
...
type _CreatePaywall403Response CreatePaywall403Response
...
func (o *CreatePaywall403Response) SetParamNil() {
	o.Param.Set(nil)
}
...
func (o *CreatePaywall403Response) SetBackoffMsNil() {
	o.BackoffMs.Set(nil)
}
...
func (o CreatePaywall403Response) MarshalJSON() ([]byte, error) {
...
func (o CreatePaywall403Response) ToMap() (map[string]interface{}, error) {
...
func (o *CreatePaywall403Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreatePaywall403Response := _CreatePaywall403Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreatePaywall403Response)

	if err != nil {
		return err
	}

	*o = CreatePaywall403Response(varCreatePaywall403Response)

	return err
}

type NullableCreatePaywall403Response struct {
	value *CreatePaywall403Response
	isSet bool
}

func (v NullableCreatePaywall403Response) Get() *CreatePaywall403Response {
	return v.value
}

func (v *NullableCreatePaywall403Response) Set(val *CreatePaywall403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePaywall403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePaywall403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePaywall403Response(val *CreatePaywall403Response) *NullableCreatePaywall403Response {
	return &NullableCreatePaywall403Response{value: val, isSet: true}
}

func (v NullableCreatePaywall403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePaywall403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
